const DEFAULT_API_VERSION = process.env.SHOPIFY_STOREFRONT_API_VERSION || "2024-01";
...
export async function fetchNewProducts(limit = 20) {
  const first = Math.max(1, Math.min(limit, 250));
 ...
 */
export async function fetchShopifyMenuAsNavItems(handle = "main-menu") {
