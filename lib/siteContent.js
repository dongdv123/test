...
// Shared trending searches - used in both search bar and trending section
export const fallbackTrendTabs = ["advent calendar", "cat", "emotional support desk pets", "golf", "puzzle"];
